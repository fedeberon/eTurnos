                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="usuarios" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${beneficiariosBySocio}" var="bo">
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="<c:url value='/beneficiario/delete?id=${bo.id}'/>"><span class="glyphicon glyphicon-trash"></span></a> </td>
